              ...
              <div className="md:w-1/3 flex flex-col items-center">
                <div className="avatar">
                  <div className="w-32 rounded-full">
                    <img src={user?.imageUrl || "/placeholder.svg?height=128&width=128&query=avatar"} alt="Profile" />
                  </div>
                </div>
              ...
              <div className="md:w-2/3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="form-control">
                    ...
                    <input type="text" className="input input-bordered" defaultValue={user?.firstName || ""} />
                  </div>
                  ...
                  <div className="form-control">
                    ...
                    <input type="text" className="input input-bordered" defaultValue={user?.lastName || ""} />
                  </div>
                </div>
