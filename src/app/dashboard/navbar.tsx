        ...
        <div className="navbar bg-base-100 border-b border-base-300 shadow-sm">
            {!isMobile && (
                <div className="flex-none hidden lg:block">
                    ...
                    >
                        <i className={`far fa-lg transition-transform duration-200 ${
                            sidebarCollapsed ? "fa-bars" : "fa-sidebar-flip"
                        }`}></i>
                    </button>
                </div>
            )}
            ...
            <div className="flex items-center gap-2">
                ...
                <div className="hidden sm:flex items-center gap-1">
                    <Link 
                        ...
                        title="Projects"
                    >
                        <i className="far fa-person-digging"></i>
                    </Link>
                    <Link 
                    ...
                    >
                        ...
                        <div className="hidden md:block text-left">
                            <div className="text-sm font-medium">
                                {user?.given_name ? `${user.given_name} ${user?.family_name || ""}`.trim() : "User"}
                            </div>
