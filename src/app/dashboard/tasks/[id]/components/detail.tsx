    ...
    return (
        <ErrorBoundary fallback={() => (
            <div className="alert alert-error">
                ...
                <div>
                    <h3 className="font-bold">Task Details Error</h3>
                    <div className="text-xs">Failed to load task details. Please refresh the page.</div>
                </div>
            </div>
        )}>
            <div>
                ...
                <ErrorBoundary fallback={() => (
                    <div className="alert alert-warning mb-6">
                        <i className="fas fa-exclamation-triangle"></i>
                        <div>
                            <h3 className="font-bold">Header section temporarily unavailable</h3>
                            <div className="text-xs">Task header couldn't be loaded.</div>
                        </div>
                    </div>
                )}>
                ...
                <ErrorBoundary fallback={() => (
                    <div className="alert alert-error">
                        <i className="fas fa-exclamation-triangle"></i>
                        <div>
                            <h3 className="font-bold">Task content temporarily unavailable</h3>
                            <div className="text-xs">Task content couldn't be loaded.</div>
                        </div>
                    </div>
                )}>
