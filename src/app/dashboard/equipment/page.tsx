...
const EquipmentNewModal = dynamic(() => import("./components/modal-new"), {
    ...
    return (
        <ErrorBoundary fallback={() => (
            <div className="alert alert-error">
                ...
                <div>
                    <h3 className="font-bold">Equipment Management Error</h3>
                    <div className="text-xs">Failed to load equipment management. Please refresh the page.</div>
                </div>
            </div>
        )}>
            <div>
                ...
                <ErrorBoundary fallback={() => (
                    <div className="alert alert-warning mb-6">
                        ...
                        <div>
                            ...
                            <div className="text-xs">Equipment statistics couldn't be loaded.</div>
                        </div>
                    </div>
                )}>
                ...
                <ErrorBoundary fallback={() => (
                    <div className="alert alert-warning mb-6">
                        ...
                        <div>
                            ...
                            <div className="text-xs">Equipment search and filtering options couldn't be loaded.</div>
                        </div>
                    </div>
                )}>
                ...
                <ErrorBoundary fallback={() => (
                    <div className="alert alert-error">
                        ...
                        <div>
                            ...
                            <div className="text-xs">Equipment data couldn't be displayed. Please refresh the page.</div>
                        </div>
                    </div>
                )}>
                    {viewType === "grid" ? (
