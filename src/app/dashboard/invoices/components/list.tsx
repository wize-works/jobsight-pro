    ...
    const handleSaveEditInvoice = (updatedInvoice: any) => {
        ...
        <ErrorBoundary fallback={() => (
            <div className="alert alert-error">
                ...
                <div>
                    <h3 className="font-bold">Invoice Management Error</h3>
                    <div className="text-xs">Failed to load invoice management. Please refresh the page.</div>
                </div>
            </div>
        )}>
            <div>
                ...
                <ErrorBoundary fallback={() => (
                    <div className="alert alert-warning mb-6">
                        ...
                        <div>
                            ...
                            <div className="text-xs">Invoice statistics couldn't be loaded.</div>
                        </div>
                    </div>
                )}>
                ...
                <ErrorBoundary fallback={() => (
                    <div className="alert alert-warning mb-6">
                        ...
                        <div>
                            ...
                            <div className="text-xs">Invoice search and filtering options couldn't be loaded.</div>
                        </div>
                    </div>
                )}>
                ...
                <ErrorBoundary fallback={() => (
                    <div className="alert alert-error">
                        <i className="fas fa-exclamation-triangle"></i>
                        <div>
                            <h3 className="font-bold">Failed to load invoices</h3>
                            <div className="text-xs">Invoice data couldn't be displayed. Please refresh the page.</div>
                        </div>
                    </div>
                )}>
                    {viewType === "grid" && (
