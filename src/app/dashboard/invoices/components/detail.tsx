            ...
            <div>
                ...
                <ErrorBoundary fallback={() => (
                    <div className="alert alert-warning mb-6">
                        ...
                        <div>
                            ...
                            <div className="text-xs">Invoice header couldn't be loaded.</div>
                        </div>
                    </div>
                )}>
                ...
                <ErrorBoundary fallback={() => (
                    <div className="alert alert-error">
                        <i className="fas fa-exclamation-triangle"></i>
                        <div>
                            <h3 className="font-bold">Invoice content temporarily unavailable</h3>
                            <div className="text-xs">Invoice content couldn't be loaded.</div>
                        </div>
                    </div>
                )}>
