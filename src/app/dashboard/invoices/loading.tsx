export default function InvoicesListLoading({ viewType = "grid" }: { viewType?: "grid" | "list" }) {
    return (
        <div>
            {/* Header */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                <div>
                    <div className="h-8 w-24 bg-base-300 animate-pulse rounded mb-2"></div>
                    <div className="h-4 w-56 bg-base-300 animate-pulse rounded"></div>
                </div>
