...
import { DashboardWidgetGrid } from './widget-renderer';
...
/**
 * Dashboard section that renders widgets by priority
 */
function DashboardSection({ priority, role }: DashboardSectionProps) {
...
/**
 * Modern dashboard component with role-based widgets
 */
export function ModernDashboard({ fallbackRole = 'member', onQuickAction }: ModernDashboardProps) {
    ...
    return (
        <div className="modern-dashboard">
            ...
            {/* Priority-based widget sections */}
            <div className="space-y-6">
                <DashboardSection priority="critical" role={effectiveRole} />
                <DashboardSection priority="important" role={effectiveRole} />
                <DashboardSection priority="informational" role={effectiveRole} />
            </div>
